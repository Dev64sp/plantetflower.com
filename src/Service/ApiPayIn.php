...
class ApiPayIn
{
    ...
    public function Payin($WalletId, $BuyerId, $annoncePoids, $shipment, $CardId,$OriginPrice, $ExistingCard)
    {
      ...
      $payIn->ExecutionDetails->SecureModeReturnURL = 'https://127.0.0.1:8000/';
